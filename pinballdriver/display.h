...
const int DISPLAY_LATCH_PIN = DISPLAY_PIN_START+5;
const int DISPLAY_DIGIT1_PIN = DISPLAY_PIN_START+6;
const int DISPLAY_DIGIT2_PIN = DISPLAY_PIN_START+7;
const int DISPLAY_DIGIT3_PIN = DISPLAY_PIN_START+8;

#define DISPLAY_DIGIT_PIN(i)    (DISPLAY_DIGIT1_PIN + i)
