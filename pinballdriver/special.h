...
const int SPECIAL_PIN_DRIVER = SPECIAL_PIN_START + 6;

const int SPECIAL_PIN_OUT_SELECT0 = SPECIAL_PIN_START2 + 0;
const int SPECIAL_PIN_OUT_SELECT1 = SPECIAL_PIN_START2 + 2;
const int SPECIAL_PIN_OUT_SELECT2 = SPECIAL_PIN_START2 + 4;

const int SPECIAL_PIN_FLIPPER_ENABLE = SPECIAL_PIN_START2 + 6;
const int SPECIAL_PIN_LEFT_FLIPPER = SPECIAL_PIN_START2 + 8;
const int SPECIAL_PIN_RIGHT_FLIPPER = SPECIAL_PIN_START2 + 10;
