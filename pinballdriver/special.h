...
const int SPECIAL_PIN_OUT_SELECT0 = SPECIAL_PIN_START + 7;
const int SPECIAL_PIN_OUT_SELECT1 = SPECIAL_PIN_START + 8;
const int SPECIAL_PIN_OUT_SELECT2 = SPECIAL_PIN_START + 9;

const int SPECIAL_PIN_FLIPPER_ENABLE = SPECIAL_PIN_START + 10;
const int SPECIAL_PIN_LEFT_FLIPPER = SPECIAL_PIN_START + 11;
const int SPECIAL_PIN_RIGHT_FLIPPER = SPECIAL_PIN_START + 12;
